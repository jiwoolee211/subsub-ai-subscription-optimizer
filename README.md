# 📱 SUBSUB (섭섭)
> **AI 기반 구독 소비 최적화 서비스** > 멋쟁이사자처럼 14기 아이디어톤 본선 진출작 🏆

<br>

<p align="center">
  <img src="assets/main_ui.png" alt="SUBSUB Main UI" width="600px" />
</p>
...
### 1. AI 구독 레포트
<img src="assets/report_ui.png" alt="AI 구독 레포트 UI" width="450px" />
...
### 2. 통합 알림 시스템
<img src="assets/notification_ui.png" alt="통합 알림 시스템 UI" width="450px" />
...
<p align="center">
  <img src="assets/flow.png" alt="Service Flow" width="650px" />
</p>
...
* 📁 **발표 자료:** [`/docs/subsub_pitch.pdf`](./docs/subsub_pitch.pdf)
